#!/usr/bin/env python3
"""
Convert QGC_TestAutomation_Manual.md to PDF using markdown + WeasyPrint.
...
MD_FILE = DOC_DIR / "QGC_TestAutomation_Manual.md"
PDF_FILE = DOC_DIR / "QGC_TestAutomation_Manual.pdf"

CSS_TEMPLATE = """
@page {
    size: A4;
    margin: 22mm 18mm 22mm 18mm;
    @top-right { content: "QGC Test Automation Manual"; font-family: "Noto Sans CJK KR", sans-serif; font-size: 9pt; color: #888; }
...
def main() -> int:
    ...
    cover_html = f"""
    <div class="cover">
      <h1>QGC 테스트 자동화 프레임워크</h1>
      <div class="subtitle">QGroundControl × PX4 SITL × OpenUxAS</div>
      <div class="meta">
...
<head>
<meta charset="UTF-8">
<title>QGC Test Automation Manual</title>
</head>
<body>
{cover_html}
{body_html}
