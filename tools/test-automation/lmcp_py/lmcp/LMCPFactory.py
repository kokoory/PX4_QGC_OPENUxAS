...
import uxas.messages.task
import uxas.messages.route
import afrl.vehicles
...
class LMCPFactory:
    def __init__(self):
        ...
        self.addSeries(SeriesEnum)
        from afrl.impact import SeriesEnum
        self.addSeries(SeriesEnum)
        from uxas.messages.uxnative import SeriesEnum
        self.addSeries(SeriesEnum)
        from uxas.messages.task import SeriesEnum
        self.addSeries(SeriesEnum)
        from uxas.messages.route import SeriesEnum
        self.addSeries(SeriesEnum)
        from afrl.vehicles import SeriesEnum
        self.addSeries(SeriesEnum)
